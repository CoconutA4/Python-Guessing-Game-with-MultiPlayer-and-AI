...
----------------------------
 ...
 <p>
   ...
   &bull; When the console knows your name it will ask if you want to play the tutorial (if you say yes it iniciates the tut funcion, else it just moves on to var modeselector)<br>
   &bull; After selecting your gamemode the program starts the specific function (sp, ai or mp) <br>
   &bull; On all the game modes you will have to chose a dificultie (var level) <br>
   &bull; If you chose sp - You have to find a number that is ramdomly generated by the computer <br>
   ...
   &bull; troll - used for wen the player doesn't cooperate with the game <br>
